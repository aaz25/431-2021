...
Next, we'll be using additional data from the [2021 County Health Rankings Data](https://www.countyhealthrankings.org/) that we saw back in Lab 02. We have compiled a larger data set called `chr_data.csv` which you will find in our [Data and Code repository](https://github.com/THOMASELOVE/431-data). This data file is the "full" data and contains all of the counties and all available variables.
...
Take a random sample of 750 counties from the full County Health Rankings Data. As part of this work, use the command:
...
Once this is done, demonstrate that Cuyahoga County in Ohio is in your sample and that the mean of `adult_obesity` is 0.335. 
