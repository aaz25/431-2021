...
2. There is an R package and set of tools called the [introverse](https://spielmanlab.github.io/introverse/articles/introverse_online.html) which is another way to get some help with basic ideas in R and the tidyverse that we'll be discussing through the semester. Here's a [quote](https://spielmanlab.github.io/introverse/index.html):
